    ...
    public Responder(final ServletContext servletContext, final Map<String, String> initialization) {
        ...
        if (initialization.containsKey("TypeBindings")) {
            for (String className : initialization.get("TypeBindings").split(",")) {
                ...
                try {
                    module = new Reflective().reflect(new Reflection<InjectorBuilder>() {
                        public InjectorBuilder reflect()
                        throws InstantiationException, IllegalAccessException {
                            return injectorBuilderClass.newInstance();
                        }
                    });
        ...
        final CoreConnector connector = new CoreConnector();
        ...
        newInjector.module(new InjectorBuilder() {
            protected void build() {
                ...
                instance(connector.getRoutes(), ilk(Routes.class), null);
            }
        });
