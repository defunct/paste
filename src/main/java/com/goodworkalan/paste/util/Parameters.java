...
import com.goodworkalan.paste.util.NamedValue.Context;
...
public class Parameters extends NamedValueList {
     ...
     */
    public static Parameters fromQueryString(String query, Context context) {
        try {
            ...
            for (String parameter : parameters) {
                ...
                namedValues.add(new NamedValue(context, name, value));
            }
