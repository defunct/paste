...
class InterceptingResponse extends HttpServletResponseWrapper { 
    ...
    public void setContentLength(int len) {
        headers.add(new NamedValue("Content-Length", Integer.toString(len)));
    ...
    public void setContentType(String type) {
        headers.add(new NamedValue("Content-Type", type));
    ...
    public void setDateHeader(String name, long date) {
        clearHeader(name);
        headers.add(new NamedValue(name, getDateFormat().format(new Date(date))));
    ...
    public void setIntHeader(String name, int value) {
        clearHeader(name);
        headers.add(new NamedValue(name, Integer.toString(value)));
